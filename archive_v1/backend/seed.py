...
def seed_database():
    ...
    try:
        ...
        # Add initial sample appointment requests matching Token A-104
        sample_appointment = models.Appointment(
            facility_id=created_facilities[0].id,
            service="General OPD",
            date="Tomorrow",
            time="10:30 AM",
            patient_name="Ramesh Pawar (DEMO)",
            phone="+91-9876543210",
            status="confirmed",
            token_number="A-104",
        ...
        db.commit()
        print(f"Database seeded successfully with {len(created_facilities)} facilities, slots, and Token A-104 appointment!")
