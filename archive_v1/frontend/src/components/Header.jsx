...
export default function Header({ lang, setLang, showDemoTools, setShowDemoTools }) {
  return (
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-sky-100 font-medium">
              {lang === 'hi'
                ? 'आसान स्वास्थ्य सेवा पहुँच प्लेटफ़ॉर्म'
