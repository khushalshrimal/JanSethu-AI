...
export default function App() {
  ...
  const [isWizardClosed, setIsWizardClosed] = useState(true);
  ...
  return (
    <div className="min-h-screen bg-slate-100 text-slate-900 flex flex-col font-sans selection:bg-sky-500 selection:text-white pb-24">
      ...
      <Header
        ...
        setShowDemoTools={setShowDemoTools}
      />

      {/* Main Container */}
      <main className="flex-1 max-w-2xl w-full mx-auto p-4 sm:p-6">
        {/* Optional Demo Tools (Hidden by default for a clean professional prototype) */}
        {showDemoTools && (
          <>
            <SihDemoWizard
